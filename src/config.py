...
COLOR_MAP = {
    ...
    '4':  {'label': 'Flamingo',  'hex': '#e67c73', 'emoji': '🧘'},  # 娱乐社交 (Relaxation)
    '5':  {'label': 'Banana',    'hex': '#f6bf26', 'emoji': '🧠'},  # 学习提升 (Learning & Growth)
    ...
    '9':  {'label': 'Blueberry', 'hex': '#3f51b5', 'emoji': '🍹'},  # 娱乐社交 (Leisure)
    '10': {'label': 'Basil',     'hex': '#0b8043', 'emoji': '💤'},  # 睡觉 (Recovery/Nap)
    '11': {'label': 'Tomato',    'hex': '#d50000', 'emoji': '⚙️'},  # 工作 (Development/Deep Work)
